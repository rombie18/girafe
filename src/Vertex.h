...
//Geeft een referentie/verwijzing naar de sensornode van deze vertex.
template<typename T>
T* Vertex<T>::getSensorNode() {
    return sensornode;
}

//Stelt de pointer naar de sensornode in (variabele ‘sensornode’ in voorgestelde UMLdiagram).
template<typename T>
